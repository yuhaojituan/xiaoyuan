package com.yuhaojituan.wemedia.gateway.filter;

import com.alibaba.fastjson.JSON;
import com.yuhaojituan.wemedia.gateway.util.AppJwtUtil;
...
public class AuthorizeFilter implements GlobalFilter {
    ...
    /**
     * 为了返回json错误信息 使用webflux的api
     * gateway用的webflux异步框架 和 springmvc差异大
     *
     * @return
     */
